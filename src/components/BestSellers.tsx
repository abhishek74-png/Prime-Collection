      ...
      <div className="mx-auto max-w-[1600px] px-6 md:px-10">
        <div className="mb-14 flex flex-col justify-between gap-8 md:flex-row md:items-end">
          <Reveal className="max-w-4xl">
            <p className="mb-5 text-[11px] uppercase tracking-[0.42em] text-white/50">Database Products</p>
            <h2 className="font-display text-balance text-4xl font-thin leading-[1] tracking-[-0.045em] text-white md:text-7xl">
              {loading ? 'Loading seeded products…' : `${products.length} products from MongoDB`}
            </h2>
          </Reveal>
          <Reveal delay={0.1} className="max-w-sm text-sm leading-8 tracking-[0.16em] text-white/60">
            This section reads directly from the MongoDB seed data, so it should display all 16 products after seeding.
          </Reveal>
        </div>
